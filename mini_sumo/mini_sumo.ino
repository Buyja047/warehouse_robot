...
// ХУГАЦААНЫ ТОХИРГОО
// =============================================================================
/* ХУРДЫГ ӨӨРЧИЛЖ ЧАДАХГҮЙ ТУЛ ЗӨВХӨН ХУГАЦААГААР ЗОХИЦУУЛНА.
   Мотор тогтмол хурдтай эргэж байгаа тул зугтах хугацаа бүрийг богиносгов.
   Хэт бага бол: хүрээнээс бүрэн салахгүй / эргэлт дутуу.
   Хэт их бол:   удаан, ард талаараа гарах эрсдэлтэй.
   Талбай дээрээ эдгээр ДӨРВӨН тоог л тааруулна.                          */
#define START_DELAY_MS  5000
#define BRAKE_MS          20  // 60 -> 20. Зөвхөн импульс тасална

// Ухралт: тогтмол хугацаа биш, ЦАГААНААС БҮРЭН САЛТАЛ ухарна.
#define BACK_MIN_MS       60  // 130 -> 60   (доод хязгаар)
#define BACK_MAX_MS      260  // 450 -> 260  (дээд хамгаалалт)
#define BACK_CLEAR_MS     35  // 90  -> 35   (цагаан алга болсны баталгаажуулалт)

// Мотор бүтэн хурдаараа эргэж байгаа тул эргэлт хурдан дуусна
#define TURN_90_MS       180  // 360 -> 180. Эргэлт дутуу бол ↑, хэтэрвэл ↓
#define TURN_180_MS      320  // 620 -> 320
#define ESC_SETTLE_MS     10  // 40  -> 10
#define ESC_FWD_MS       250  // 380 -> 250. Төв рүү чигээрээ явах
...
// 0.55 нь хэт зөөлөн байсан — зурагдсан хэсгийг цагаан гэж үзэж байв.
#define WHITE_FACTOR    0.40
#define MIN_BLACK_MARGIN 120

#define LINE_CONFIRM       7  // дараалсан цагаан уншилт
                              // ХЭТ ИХ мэдэрвэл ↑ (9, 11), хүрээгээ алдвал ↓
#define LINE_SAMPLE_US   450  // 700 -> 450: 7 уншилт 4.9 мс байсныг 3.2 мс болгов
                              // (зурагдсаныг шүүх ажлыг CAL_K хийж байгаа тул
                              //  хугацааны шүүлтийг богиносгож хариу үйлдлийг түргэсгэв)
